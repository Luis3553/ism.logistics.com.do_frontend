...
export const DateManager = ({ daysInMonth, months, setDay, setMonth, setYear, day, month, year }: DatePickerFielldsProps) => {
    return (
        <div className="grid grid-cols-2 min-[640px]:grid-cols-[1fr_auto_auto_auto] gap-x-7 gap-y-2">
            <div className="flex justify-start gap-4">
                <div className="flex flex-col min-[400px]:flex-row min-[400px]:items-center gap-2">
                    <span className="font-semibold text-brand-dark-gray text-base">Ficha</span>
                    <div className="form-select-wrapper w-full min-[640px]:w-fit">
                        <select id="record" name="country" autoComplete="country-name" className="form-select">
                            <option>Todas</option>
                        </select>
