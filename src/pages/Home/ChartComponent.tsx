...
export const ChartComponent = () => {
    ...
    return (
        <>
            <Tab.Group onChange={(n) => setTabIndex(n)}>
                <div className={"grid grid-cols-1 min-[640px]:grid-cols-[min(170px,_20%)_1fr] p-4 mt-4 bg-white rounded-lg shadow-sm gap-y-4 grow"}>
                    <Tab.List className='hidden min-[640px]:flex flex-col gap-3 my-auto w-full h-fit'>
