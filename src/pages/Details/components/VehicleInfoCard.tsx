...
export const VehicleInfoCard = () => {
    return (
        <div className="flex flex-col p-4 text-center bg-white rounded-lg shadow-sm hover:shadow-md hover:bg-brand-blue bottom-0 hover:bottom-1 group relative transition-all duration-300">
            ...
            <div className="grid w-full grid-cols-2 grow">
                {VehicleCardLineInfoStructure.map((line, i) => (
                    <React.Fragment key={i}>
                        <span className="text-left text-brand-dark-gray group-hover:text-white">{line.title}</span>
